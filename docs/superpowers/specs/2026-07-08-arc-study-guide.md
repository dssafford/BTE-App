# Claude ARC Foundations — Official Study Guide (Exam Topics & Skills)

Reference source for question generation. Exam domain weights:
...
Note: the domain *numbering* below follows the study guide's internal
section numbers (Domain 2 = Tool Design & MCP, Domain 3 = Claude Code),
which differ from the weight-table ordering above. Subdomain IDs (1.x,
2.x, …) always refer to the section numbers below.
